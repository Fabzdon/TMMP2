...
<div class="container">
    <h2>Register for Monthly Pay 1 Year Span Plan</h2>
    <br>
    <form method="post" enctype="multipart/form-data" action="success.php">

        <input type="hidden" name="planname" value="4">
        ...
        <div class="mb-3">
            ...
            <input required type="email" class="form-control" for="email" id="email" placeholder="Email Address "
        ...
        <div class="mb-3">
            ...
            <input type="text" name="contactnum" class="form-control" id="contactnum" placeholder="Contact Number"
